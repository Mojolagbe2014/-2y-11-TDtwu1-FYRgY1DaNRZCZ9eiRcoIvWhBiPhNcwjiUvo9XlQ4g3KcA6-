...
class Contest implements ContentManipulator{
    ...
    public function update() {
        $sql = "UPDATE ".self::$tableName." SET title = '{$this->title}', intro = '{$this->intro}', description = '{$this->description}', header = '{$this->header}', logo = '{$this->logo}', start_date = '{$this->startDate}', end_date = '{$this->endDate}', announcement_date = '{$this->announcementDate}', winners = '{$this->winners}', question = '{$this->question}', answer = '{$this->answer}', point = '{$this->point}', bonus_point = '{$this->bonusPoint}', rules = '{$this->rules}', prize = '{$this->prize}', message = '{$this->message}', css = '{$this->css}', announce_winner = '{$this->announceWinner}', restart = '{$this->restart}', restart_interval = '{$this->restartInterval}' WHERE id = $this->id ";
        if(!empty($this->id)){
            $result = self::$dbObj->query($sql);
