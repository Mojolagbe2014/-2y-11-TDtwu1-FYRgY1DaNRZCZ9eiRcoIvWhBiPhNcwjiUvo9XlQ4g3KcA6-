$(document).ready(function(){
    ...
    var formVar = {id:sessionStorage.SWPadminId, name:sessionStorage.SWPAdminFullName, email:sessionStorage.SWPadminEmail, userName:sessionStorage.SWPAdminName, role:sessionStorage.SWPAdminRole};
